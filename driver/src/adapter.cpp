...
#define CABLE_PRIME_BYTES       (48000 * 4 / 50)
...
--*/
    ...
    ntStatus = g_Cable.Init(CABLE_CAPACITY_BYTES, CABLE_PRIME_BYTES);
    IF_FAILED_ACTION_JUMP(
        ntStatus,
        DPF(D_ERROR, ("Cable buffer allocation failed, 0x%x", ntStatus)),
        Done);
