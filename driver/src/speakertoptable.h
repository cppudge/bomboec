...
//=============================================================================
// Узлов volume/mute в топологии нет: кабель копирует байты как есть, а узлы из
// образца только хранили значения (ползунок в Windows ни на что не влиял).
// Без аппаратных узлов громкость и mute endpoint'а применяет audio engine.
static
